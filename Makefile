...
GOERLI_CLUB_SC_ADDRESS=
GOERLI_DONATION_SC_ADDRESS=
GOERLI_721_SC_ADDRESS=
GOERLI_1155_SC_ADDRESS=
GOERLI_MARKETPLACE_SC_ADDRESS=
...
### GOERLI
goerli-verify-club: 
		$(YARN_HARDHAT_BASE) verify --network $(GOERLI_NETWORK) $(MUMBAI_CLUB_SC_ADDRESS) ${NAVTIVE_TOKEN_WRAPPER} --show-stack-traces
goerli-verify-donation: 
		$(YARN_HARDHAT_BASE) verify --network $(GOERLI_NETWORK) $(MUMBAI_DONATION_SC_ADDRESS) ${NAVTIVE_TOKEN_WRAPPER} --show-stack-traces
goerli-verify-721: 
		$(YARN_HARDHAT_BASE) verify --network $(GOERLI_NETWORK) $(MUMBAI_721_SC_ADDRESS) --show-stack-traces
goerli-verify-1155: 
		$(YARN_HARDHAT_BASE) verify --network $(GOERLI_NETWORK) $(MUMBAI_1155_SC_ADDRESS) --show-stack-traces
goerli-verify-marketplace: 
		$(YARN_HARDHAT_BASE) verify --network $(GOERLI_NETWORK) $(MUMBAI_MARKETPLACE_SC_ADDRESS) ${NAVTIVE_TOKEN_WRAPPER} ${SWYL_NFT_SERVICE_RECIPIENT} ${SWYL_NFT_DEFAULT_PLATOFRM_FREE_BPS} --show-stack-traces
